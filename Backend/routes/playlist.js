...
router.post( //remember that the Auth token used in the create song API and the one to be used here must be same. since only a playlst owner can create playlist.
    "/create",
